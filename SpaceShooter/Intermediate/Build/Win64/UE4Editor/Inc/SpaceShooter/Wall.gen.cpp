...
// Cross Module References
	SPACESHOOTER_API UClass* Z_Construct_UClass_AWall_NoRegister();
	SPACESHOOTER_API UClass* Z_Construct_UClass_AWall();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWall_Statics::NewProp_wallMesh_MetaData[] = {
		...
		{ "Category", "Mesh" },
		{ "Comment", "/** The walls static mesh */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Wall.h" },
		{ "ToolTip", "The walls static mesh" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AWall_Statics::NewProp_wallMesh = { "wallMesh", nullptr, (EPropertyFlags)0x00400000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AWall, wallMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AWall_Statics::NewProp_wallMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AWall_Statics::NewProp_wallMesh_MetaData)) };
	...
	IMPLEMENT_CLASS(AWall, 340233082);
	template<> SPACESHOOTER_API UClass* StaticClass<AWall>()
	{
		return AWall::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AWall(Z_Construct_UClass_AWall, &AWall::StaticClass, TEXT("/Script/SpaceShooter"), TEXT("AWall"), false, nullptr, nullptr, nullptr);
